...
export default class Display {
    ...
    refresh() {
        const viewport = this._viewportLoc;
        this._damage(viewport.x, viewport.y, viewport.w, viewport.h);
        this.flip();
    }
    ...
    dispose() {
        for (const action of this._renderQ) {
            ...
            if (action.frame.ready) {
                action.frame.frame?.close();
            } else {
                // The decoder will close the frame when it eventually arrives.
                action.frame.keep = false;
            }
        }
        this._renderQ = [];
