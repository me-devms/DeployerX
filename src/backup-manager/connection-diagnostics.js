...
const NEXT_ACTIONS = Object.freeze({
  ...
  MARIADB_NATIVE_TOOL_NOT_FOUND: 'Open the MariaDB installer, add mariadb and mariadb-dump to PATH, then run the test again.',
  POSTGRESQL_NATIVE_TOOL_NOT_FOUND: 'Open the PostgreSQL installer, add psql and pg_dump to PATH, then run the test again.',
  POSTGRESQL_CREDENTIALS_UNAVAILABLE: 'Edit the PostgreSQL connection and enter the password again, then run the test again.',
  SQLSERVER_SQLCMD_NOT_FOUND: 'Open the Microsoft sqlcmd installer, add sqlcmd to PATH, then run the test again.',
  ORACLE_SQLPLUS_NOT_FOUND: 'Open the Oracle Instant Client installer, add SQL*Plus to PATH, then run the test again.',
  MONGODB_MONGOSH_NOT_FOUND: 'Open the MongoDB Database Tools installer, add mongosh and mongodump to PATH, then run the test again.',
  REDIS_CLI_NOT_FOUND: 'Install redis-cli, add it to PATH, then run the test again.',
  CASSANDRA_PRODUCT_UNAVAILABLE: 'Open the Cassandra installer, add the required Cassandra tools to PATH, then run the test again.',
  SCYLLA_PRODUCT_UNAVAILABLE: 'Open the ScyllaDB installer, add the required tools to PATH, then run the test again.',
